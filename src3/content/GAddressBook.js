...
function GAddressBook(aDirectory) {
  // Make a new AddressBook object and copy everything over
  var ab = new AddressBook(aDirectory);
  for (var i in ab) {
    if (!this[i])
      this[i] = ab[i];
  }
...
GAddressBook.prototype = {
   ...
   */
  setUsername: function GAddressBook_setUsername(aUsername) {
   ...
   */
  getUsername: function GAddressBook_getUsername() {
   ...
   */
  setPrimary: function GAddressBook_setPrimary(aPrimary) {
   ...
   */
  getPrimary: function GAddressBook_getPrimary() {
   ...
   */
   getGroupID: function GAddressBook_getGroupID() {
   ...
   * @return The ID of the group with which this directory is synchronized.
   */
   setGroupID: function GAddressBook_setGroupID(aGroupID) {
    ...
    */
   getLastSyncDate: function GAddressBook_getLastSyncDate() {
    ...
    */
   setLastSyncDate: function GAddressBook_setLastSyncDate(aLastSync) {
    ...
    */
  reset: function GAddressBook_reset(checkListener) {
  ...
  newListObj: function GAddressBook_newListObj(aList, aParentDirectory, aNew) {
   ...
   */
  getAllLists: function GAddressBook_getAllLists(skipGetCards) {
